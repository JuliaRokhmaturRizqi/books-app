...
export default function PopulerBookScreen({ navigation }) {
    ...
    <SafeAreaProvider>
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Novel Terpopuler</Text>
